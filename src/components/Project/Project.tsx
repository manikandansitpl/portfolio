      ...
      <div className="projects">
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Gigame The Online Learning platform</h3>
              <p>
                {" "}
                Gigame is the online learning platform Project I have
                contributed most of the modules like video streamings , and
                messaging authentications student management and realtime data
                transfer by using SOCKET.IO{" "}
              </p>
            </div>
            <footer>
              {" "}
              <ul className="tech-list">
                {" "}
                <li>React</li> <li>Zego cloud</li> <li>mongo DB</li>
                <li>JWT</li>
                <li>Typescript</li>
                <li>Socket.io</li>{" "}
              </ul>{" "}
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>MedBot </h3>
              <p>
                Medbot is the all in one medical app here we can manage the
                doctor and patients and pharmacies here i have worked on UI
                designs and Functional implementations in React-Native app ,
                from frontEnd side i have done mobile number and google login by
                using firebase and for state management and API's i am using
                redux tool kit and i have handle push-notification in this app
                for back-end we are using node js and mongoDB for REST-APi's and
                we have implement payment gate-way by using stripe
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Inperact</h3>
              <p>
                Inperact is the events management mobile app here i worked as
                the backend developer here i am create REST-API's for the entire
                mobile app here i created initialized bew events and create
                conferences in that meeting and user authentications and
                userProfiles and user connections like linkedin i used AWS to
                deploy this app and to image storage i Used S3 bucket{" "}
              </p>
            </div>
            <footer>
              <ul className="tech-list">
